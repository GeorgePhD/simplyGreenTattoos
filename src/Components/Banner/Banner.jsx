                    ...
                    <div role="alert" className="relative w-full text-base font-regular px-4 py-4 rounded-lg bg-white border border-green-300 text-white flex">
                        <div className=" mr-12">
                            ...
                            <a href="https://wa.me/56961107025" target="_blank">
                                <span title="" className="inline-flex items-center justify-center text-sm text-green-500 transition-all ml-4 duration-200 rounded-md hover:text-green-700" role="button">
